...
class Seq2SeqTransformer(nn.Module):
    def __init__(self,
        ...
        self.transformer = Transformer(
                                       ...
                                       dim=emb_size,n_heads=nhead,ffn_dim=dim_feedforward,\
                                       dropout=dropout,return_inter = False,causal=True)
    ...
    def forward(self,
        ...
        outs,_ = self.transformer(trg,src,src_mask=src_mask,tgt_mask=tgt_mask,src_pad_mask=src_pad_mask,tgt_pad_mask=tgt_pad_mask)
